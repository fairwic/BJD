...
本目录包含 BJD 团购平台（拼团大师）的按域拆分的功能文档。

## 文档结构

| 文档 | 域名称 | 包含页面 | 优先级 |
|------|--------|----------|--------|
| [01_认证体系.md](./01_认证体系.md) | 用户认证 | Login, ForgotPassword, RealNameVerification, AccountSecurity, ProfileEdit | P0 |
| [02_地址支付.md](./02_地址支付.md) | 地址与支付 | AddressManagement, PaymentSettings | P0 |
| [03_商品浏览.md](./03_商品浏览.md) | 商品浏览 | UserShop, ProductDetail, LeaderProfile, MerchantProfile | P0 |
