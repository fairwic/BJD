    ...
    <div className="pb-20 bg-gray-50 min-h-screen">
      ...
      <div className="mt-3 bg-white rounded-xl divide-y divide-gray-50">
        ...
        <div
          ...
          className="flex items-center gap-3 p-4 active:bg-gray-50 bg-gradient-to-r from-rose-50/30 to-transparent"
        >
        ...
        <div
          ...
          className="flex items-center gap-3 p-4 active:bg-gray-50 bg-gradient-to-r from-purple-50/30 to-transparent"
        >
        ...
        <div
          ...
          className="flex items-center gap-3 p-4 active:bg-gray-50 bg-gradient-to-r from-blue-50/30 to-transparent"
        >
      ...
      <div className="mt-4 p-4">
        <button
          onClick={() => push("Login")}
          className="w-full py-3 text-red-500 bg-white rounded-xl text-sm font-bold"
        >
          退出登录
        </button>
      </div>
    ...
    <div className="pb-20 p-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div
          ...
          className="bg-rose-50 p-4 rounded-xl flex flex-col items-center justify-center gap-2 text-rose-600 active:scale-95 transition-transform"
        >
          ...
          <div className="flex items-center gap-2">
            ...
            {post.tags &&
              post.tags.map((tag, i) => (
                <span
                  key={i}
                  className="text-[10px] bg-rose-50 text-rose-500 px-1.5 py-0.5 rounded-full"
                >
                  {tag}
                </span>
              ))}
    ...
    <div className="pb-20">
      ...
      <div className="bg-gray-50 min-h-screen">
        <div className="p-3 space-y-2">
          ...
          <div
            onClick={() => push("KnowledgeBase")}
            className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-3 flex items-center gap-3 cursor-pointer active:scale-98 transition-transform"
          >
          ...
          <div
            ...
            className="bg-gradient-to-r from-rose-100 to-purple-100 rounded-xl p-3 flex items-center gap-3 cursor-pointer active:scale-98 transition-transform"
          >
