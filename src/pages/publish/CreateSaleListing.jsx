    ...
    return (
        <div className={`min-h-screen flex flex-col bg-gradient-to-br ${theme.gradient}`}>
             ...
             <div className="px-4 h-14 flex items-center justify-between sticky top-0 z-30 bg-white/70 backdrop-blur-md">
                ...
                <button onClick={handlePublish} className={`font-bold text-sm px-4 py-1.5 rounded-full text-white shadow-lg shadow-rose-500/30 active:scale-95 transition-all ${theme.btn}`}>
                    发布
                </button>
            </div>
